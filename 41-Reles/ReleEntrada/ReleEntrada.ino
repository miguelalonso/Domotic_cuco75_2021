 ...
 * Control Rele luz Rele de entrada cuco75
 *  
 * D5--> Boton - equivalente al botón ya instalado en la Rele
 * D6--> Rele pulso para abir/cerrar  Rele
...
#include <Espalexa.h>
//callback functions
void releChanged(uint8_t brightness);
Espalexa espalexa;

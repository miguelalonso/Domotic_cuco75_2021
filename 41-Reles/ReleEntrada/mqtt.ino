...
const char* mqttTopicSub ="cuco75/ReleEntrada";            //topic
...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 Serial.println("-----------------------");
  ...
  if (strcmp(topic , "cuco75/ReleEntrada")==0){ 
    Serial.print("The message arrived from the topic: ");
    Serial.println(topic);
  ...
  client.publish("cuco75/ReleEntrada/confirma", p, length);
 ...
 while (!client.connected()) {
  ...
  void publicar_mqtt(){
    ...
    if (now - lastMsg > 120000) {
      ...
      snprintf (msg, MSG_BUFFER_SIZE, "millis ReleEntrada #%ld", now);
      //Serial.print("Publish message: ");
      //Serial.println(msg);
      client.publish("cuco75/ReleEntrada/millis", msg);
      //String ip3=String(WiFi.localIP()[3]);
      snprintf (msg, MSG_BUFFER_SIZE, "ip ReleEntrada #%ld", WiFi.localIP()[3]);
      client.publish("cuco75/ReleEntrada/ip", msg);
      
      snprintf (msg, MSG_BUFFER_SIZE, "Estado ReleEntrada #%ld", estados[0]);
      client.publish("cuco75/ReleEntrada/estado", msg);
    }
  }

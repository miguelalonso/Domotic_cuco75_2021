...
//    });
    ...
    espalexa.addDevice("PuertaGaraje", puertaChanged); //simplest definition, default state off
...
void puertaChanged(uint8_t brightness) {
    Serial.print("Alexa: puerta changed to ");
    ...
    if (brightness > 200) {
      ...
      Abrirpuerta_parcial(brightness); //porcentaje en brillo de 0 a 255
    }
}

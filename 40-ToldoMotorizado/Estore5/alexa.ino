...
//    });
    ...
    espalexa.addDevice("Estore5", EstoreChanged); //simplest definition, default state off
...
void EstoreChanged(uint8_t brightness) {
    Serial.print("Alexa: Estore changed to ");
    ...
    if (brightness > 200) {
      ...
      AbrirEstore_parcial(brightness); //porcentaje en brillo de 0 a 255
    }
}

...
const char* mqttTopicSub ="cuco75/Persiana1";            //topic
...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 Serial.println("-----------------------");
  ...
  if (strcmp(topic , "cuco75/Persiana1")==0){ 
    Serial.print("The message arrived from the topic: ");
    Serial.println(topic);
  ...
  client.publish("cuco75/Persiana1/confirma", p, length);
 ...
 while (!client.connected()) {
  ...
  void publicar_mqtt(){
    ...
    if (now - lastMsg > 120000) {
      ...
      snprintf (msg, MSG_BUFFER_SIZE, "millis Persiana1 #%ld", now);
      //Serial.print("Publish message: ");
      //Serial.println(msg);
      client.publish("cuco75/Persiana1/millis", msg);
      //String ip3=String(WiFi.localIP()[3]);
      snprintf (msg, MSG_BUFFER_SIZE, "ip Persiana1 #%ld", WiFi.localIP()[3]);
      client.publish("cuco75/Persiana1/ip", msg);
      
      snprintf (msg, MSG_BUFFER_SIZE, "Estado Persiana1 #%ld", estados[0]);
      client.publish("cuco75/Persiana1/estado", msg);
    }
  }

...
//    });
    ...
    espalexa.addDevice("Estore1", Estore1Changed); //simplest definition, default state off
...
void Estore1Changed(uint8_t brightness) {
    Serial.print("Alexa: Estore1 changed to ");

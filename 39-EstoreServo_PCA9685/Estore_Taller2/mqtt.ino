...
const char* mqttTopicSub ="cuco75/Estore_Taller2";            //topic
...
void setup_mqtt() {
 ...
 while (!client_mqtt.connected()) {
   Serial.println("Connecting to MQTT Broker...");
    String clientId = "Estore_Taller2-";
...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 Serial.print("2:The message arrived from the topic: ");
  ...
  if (strcmp(topic , "cuco75/Estore_Taller2")==0){ 
    Serial.print("The message arrived from the topic: ");
    Serial.println(topic);
 ...
 counter=0;
  ...
  void publicar_mqtt(){
    ...
    if (now - lastMsg > 65000) {
      lastMsg = now;
      ++value;
      snprintf (msg, MSG_BUFFER_SIZE, "Estore_Taller2 millis #%ld", now);
      //Serial.print("Publish message: ");
      //Serial.println(msg);
      client_mqtt.publish("cuco75/millis", msg);
      snprintf (msg, MSG_BUFFER_SIZE, "Estore_Taller2 ip #%ld", WiFi.localIP()[3]);
      client_mqtt.publish("cuco75/millis", msg);
    }
  }

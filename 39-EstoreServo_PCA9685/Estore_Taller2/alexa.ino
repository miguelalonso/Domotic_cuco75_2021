...
//    });
    ...
    espalexa.addDevice("Estore_Taller2", Estore_Taller2Changed); //simplest definition, default state off
...
void Estore_Taller2Changed(uint8_t brightness) {
    Serial.print("Alexa: Estore_Taller2 changed to ");

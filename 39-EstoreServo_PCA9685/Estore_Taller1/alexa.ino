...
//    });
    ...
    espalexa.addDevice("Estore_Taller1", Estore_Taller1Changed); //simplest definition, default state off
...
void Estore_Taller1Changed(uint8_t brightness) {
    Serial.print("Alexa: Estore_Taller1 changed to ");

...
//    });
    ...
    espalexa.addDevice("Estore3", Estore3Changed); //simplest definition, default state off
...
void Estore3Changed(uint8_t brightness) {
    Serial.print("Alexa: Estore3 changed to ");

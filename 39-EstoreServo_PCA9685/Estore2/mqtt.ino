...
const char* mqttTopicSub ="cuco75/Estore2";            //topic
...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 Serial.print("2:The message arrived from the topic: ");
  ...
  if (strcmp(topic , "cuco75/Estore2")==0){ 
    Serial.print("The message arrived from the topic: ");
    Serial.println(topic);
 ...
 counter=0;
  ...
  void publicar_mqtt(){
    ...
    if (now - lastMsg > 65000) {
      lastMsg = now;
      ++value;
      snprintf (msg, MSG_BUFFER_SIZE, "Estore2 millis #%ld", now);
      //Serial.print("Publish message: ");
      //Serial.println(msg);
      client_mqtt.publish("cuco75/millis", msg);
      snprintf (msg, MSG_BUFFER_SIZE, "Estore2 ip #%ld", WiFi.localIP()[3]);
      client_mqtt.publish("cuco75/millis", msg);
    }
  }
